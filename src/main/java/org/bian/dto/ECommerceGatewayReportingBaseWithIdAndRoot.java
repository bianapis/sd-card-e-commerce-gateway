...
/**
 * ECommerceGatewayReportingBaseWithIdAndRoot
 */
public class ECommerceGatewayReportingBaseWithIdAndRoot   {
  private String eCommerceGatewayServiceSessionReference = null;

  private String eCommerceTransactionReportingReference = null;

  private Object eCommerceTransactionReportingRecord = null;
  ...
  private String eCommerceTransactionAuthenticationReference = null;

  private String eCommerceTransactionAuthenticationResponse = null;

  private String eCommerceTransactionAuthorizationReference = null;

  private String eCommerceTransactionAuthorizationResponse = null;
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: eCommerce Transaction Reporting Reference 
   * @return eCommerceTransactionReportingReference
  **/

  @JsonGetter("eCommerceTransactionReportingReference")
  public String getECommerceTransactionReportingReference() {
    return eCommerceTransactionReportingReference;
  }
  
  @JsonSetter("eCommerceTransactionReportingReference")
  public void setECommerceTransactionReportingReference(String eCommerceTransactionReportingReference) {
    this.eCommerceTransactionReportingReference = eCommerceTransactionReportingReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: returned report  
   * @return eCommerceTransactionReportingRecord
  **/

  @JsonGetter("eCommerceTransactionReportingRecord")
  public Object getECommerceTransactionReportingRecord() {
    return eCommerceTransactionReportingRecord;
  }
  
  @JsonSetter("eCommerceTransactionReportingRecord")
  public void setECommerceTransactionReportingRecord(Object eCommerceTransactionReportingRecord) {
    this.eCommerceTransactionReportingRecord = eCommerceTransactionReportingRecord;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: the following transaction details may not be required for card authentication 
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: eCommerce Transaction Authentication Reference 
   * @return eCommerceTransactionAuthenticationReference
  **/

  @JsonGetter("eCommerceTransactionAuthenticationReference")
  public String getECommerceTransactionAuthenticationReference() {
    return eCommerceTransactionAuthenticationReference;
  }
  
  @JsonSetter("eCommerceTransactionAuthenticationReference")
  public void setECommerceTransactionAuthenticationReference(String eCommerceTransactionAuthenticationReference) {
    this.eCommerceTransactionAuthenticationReference = eCommerceTransactionAuthenticationReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: result of the card authentication request 
   * @return eCommerceTransactionAuthenticationResponse
  **/

  @JsonGetter("eCommerceTransactionAuthenticationResponse")
  public String getECommerceTransactionAuthenticationResponse() {
    return eCommerceTransactionAuthenticationResponse;
  }
  
  @JsonSetter("eCommerceTransactionAuthenticationResponse")
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: eCommerce Transaction Authorization Reference 
   * @return eCommerceTransactionAuthorizationReference
  **/

  @JsonGetter("eCommerceTransactionAuthorizationReference")
  public String getECommerceTransactionAuthorizationReference() {
    return eCommerceTransactionAuthorizationReference;
  }
  
  @JsonSetter("eCommerceTransactionAuthorizationReference")
  public void setECommerceTransactionAuthorizationReference(String eCommerceTransactionAuthorizationReference) {
    this.eCommerceTransactionAuthorizationReference = eCommerceTransactionAuthorizationReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: result of the transaction authorization request 
   * @return eCommerceTransactionAuthorizationResponse
  **/

  @JsonGetter("eCommerceTransactionAuthorizationResponse")
  public String getECommerceTransactionAuthorizationResponse() {
    return eCommerceTransactionAuthorizationResponse;
  }
  
  @JsonSetter("eCommerceTransactionAuthorizationResponse")
